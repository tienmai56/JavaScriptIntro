...
//3.1 data type of outermost layer is object
//3.2 hits property is an object (an array of objects to be more specific)
//3.3 In each hit of hits, how to find the job’s title, locations, salary, benefits, skills and requirements
//jobsearch.hits[index_of_each_of_the_hit]['name_of_the_attribute']
//example:
console.log(jobsearch.hits[0]['jobTitle'])
console.log(jobsearch.hits[0]['benefits'])
